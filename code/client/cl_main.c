...
#define REND_ARCH_STRING ARCH_STRING
	...
	Com_Printf( "CL_InitRef: cl_renderer is \"%s\"\n", cl_renderer->string );
	...
	loadedPath = FS_LoadedLibraryPath();
	Com_Printf( "CL_InitRef: loaded renderer module from %s\n",
		loadedPath[0] ? loadedPath : dllName );
